...
import { MissingAlertSchemaFormData, MAX_FILE_SIZE } from "../types";
...
export interface PetDataFormStepProps {
  increaseStep: () => void;
  trigger: UseFormTrigger<MissingAlertSchemaFormData>;
  ...
  resetField: UseFormResetField<MissingAlertSchemaFormData>;
...
export default function PetDataFormStep({
  ...
  type MissingAlertSchemaFormDataKeys = keyof MissingAlertSchemaFormData;

  const petFields: MissingAlertSchemaFormDataKeys[] = [
    "name",
    "gender",
    "age",
    "colors",
