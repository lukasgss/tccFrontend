...
import CreateMissingAlertButton from "./CreateMissingAlertButton";

export default function MissingAnimalListingHeading() {
  ...
  return (
    ...
    >
      <Title order={3}>Animais Desaparecidos</Title>
      {isDesktop && <CreateMissingAlertButton />}
    </div>
  );
}
