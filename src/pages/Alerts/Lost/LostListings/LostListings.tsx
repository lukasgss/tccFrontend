...
export default function LostListings() {
      ...
      <main className="min-h-screen">
        ...
        <div className="relative mx-auto w-fit">
          <WorkInProgressPage
            ...
            description="Estamos preparando novas funcionalidades para ajudar você a divulgar animais perdidos. 
          Logo você poderá utilizar a plataforma para encontrar seu melhor amigo perdido!"
          />
